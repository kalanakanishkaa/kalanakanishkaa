...
<p align="left">
I am a <b>Data Science Undergraduate</b> passionate about building end-to-end Machine Learning models, cloud-native deployments, and modern web applications.
</p>

* 🚀 **Currently Working On:** Production MLOps Pipelines & AWS Cloud Deployments
* 💡 **Core Interests:** Machine Learning, Predictive Analytics, Infrastructure as Code (Terraform) & Docker
* 🎯 **Career Goal:** Delivering robust AI and Software Solutions to drive real-world business value

<div align="center">
  <img src="https://media.giphy.com/media/qgQUGGAC3P4PPmmgcM/giphy.gif" width="60%" alt="Data Analytics Animated GIF"/>
</div>
...
* 🐾 **[PetPulse AI](https://github.com/kalanakanishkaa/petpulse-ai)** — AI-driven pet health analytics and intelligent care dashboard.
* 💰 **[Smart Expense Tracker](https://github.com/kalanakanishkaa/smart-expense-tracker)** — Full-stack finance tracking application with interactive visualization.
* 🤖 **[Churn MLOps Pipeline](https://github.com/kalanakanishkaa/churn-mlops-project)** — End-to-end customer churn prediction served via FastAPI and containerized with Docker.
* ☁️ **[AWS ECS Deployment](https://github.com/kalanakanishkaa/ecs-deployment-project)** — Automated microservices cloud infrastructure using Terraform & CI/CD.
* 📊 **[E-Commerce Analytics](https://github.com/kalanakanishkaa/ecommerce-analytics-project)** — Comprehensive exploratory data analysis on consumer behaviors.
* 🚢 **[Titanic Survival Analysis](https://github.com/kalanakanishkaa/Titanic-Survival-Analysis)** — Supervised classification ML pipeline with feature engineering.
